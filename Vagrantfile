...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "epsilondevops" do |epsilondevops|
    epsilondevops.vm.box = default_box
    epsilondevops.vm.hostname = "epsilon"
    ...
    for p in 30000..30100 # expose NodePort IP's
      ...
      epsilondevops.vm.provider "virtualbox" do |v|
      v.memory = "3072"
      v.name = "epsilon"
      end
      epsilondevops.vm.provision "shell", inline: <<-SHELL
      sudo zypper refresh
